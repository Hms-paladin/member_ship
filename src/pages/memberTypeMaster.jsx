      ...
      const APIURL=apiurl;
      var t_name='mas_membertype';    
      var objkey={'mem_TypeName':'','mem_TypeDescription':''};
      var objkey1={'mem_TypeName':'','mem_TypeDescription':''};
      var validataions={'mem_TypeName':'','mem_TypeDescription':''};
      var validataions1={'mem_TypeName':'','mem_TypeDescription':''};
      var clearData={'mem_TypeName':'','mem_TypeDescription':''};
      var primary_key='mem_TypeId';
      ...
      var mydata={fields:[
        ...
        {
          "key":"mem_TypeId",
          "alias":"Member Type ID" ,
          "validations":[ {name:"required",params:''}]
        },
        //..........................
        {
          "key":"mem_TypeName",
          "alias":"Member Type Name" ,
          "validations":[ {name:"required",params:''}]
        },
         {
          "key":"mem_TypeDescription",
          "alias":"Member Type Description" ,
          "validations":[ {name:"required",params:''}]
        },
  ...
  var self=""
  class MemberTypeMaster extends Component {
    constructor(props) {
     ...
     this.state = {
      ...
      handleClose = () => {
        ...
        updatetDynMaster(data){
          var obj={fields:data,table_name:t_name,primarykey:"mem_TypeId"};
        ...
        render() {
          ...
          console.log(this.state.tblValues,"rendering")
          return (
            <div>
            <card>
