      ...
      var objkey={'mas_info_cat_name':''};
      var objkey1={'mas_info_cat_name':''};
      var validataions={'mas_info_cat_name':''}
      var validataions1={'mas_info_cat_name':''}
      var clearData={'mas_info_cat_name':''}
      var primary_key='mas_info_cat_id';
     ...
     this.state = {
      ...
      handleClose = () => {
        ...
        updatetDynMaster(data){
          var obj={fields:data,table_name:t_name,primarykey:"mas_info_cat_id"};
