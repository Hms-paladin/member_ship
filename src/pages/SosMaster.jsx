      ...
      const APIURL=apiurl;
      var t_name='mas_sos';    
      var objkey={'sos_name':'','sos_email':'','sos_countrycode':'','sos_mobile':''};
      var objkey1={'sos_name':'','sos_email':'','sos_countrycode':'','sos_mobile':''};
      var validataions={'sos_name':'','sos_email':'','sos_countrycode':'','sos_mobile':''}
      var validataions1={'sos_name':'','sos_email':'','sos_countrycode':'','sos_mobile':''}
      var clearData={'sos_name':'','sos_email':'','sos_countrycode':'','sos_mobile':''}
      var primary_key='sos_id';
      ...
      var mydata={fields:[
        ...
        },
        {
          "key":"sos_email",
          "alias":"SOS Email" ,
          "validations":[ {name:"required",params:''},{name:'email'}]
        },
          {
          "key":"sos_countrycode",
          "alias":"SOS Country Code" ,
          "validations":[ {name:"required",params:''},{name:'allowNumaricOnly'}]
        },
          {
          "key":"sos_mobile",
          "alias":"SOS Mobile" ,
          "validations":[ {name:"required",params:''},{name:'mobile'}]
        },
  ...
  var self=""
  class SosMaster extends Component {
    constructor(props) {
     ...
     this.state = {
      ...
      handleClose = () => {
        ...
        insertDynMaster(data){
          ...
          .then((responseJson) => {
            console.log("insertValues",responseJson);
             this.setState({message:"Successfully Inserted",snackbarstate: true });
        ...
        updatetDynMaster(data){
          var obj={fields:data,table_name:t_name,primarykey:"sos_id"};
          ...
          .then((responseJson) => {
            ...
            this.setState({message:"Successfully Updated",snackbarstate: true });
            this.loadTableData();
        ...
        deleteDynMaster=(data) =>{
          ...
          .then((responseJson) => {
          this.setState({message:"Successfully Deleted",snackbarstate: true });
            this.setState({ unselectData: true });
