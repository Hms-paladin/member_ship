      ...
      const APIURL=apiurl;
      var t_name='mas_city';    
      var objkey={'city_Name':''};
      var objkey1={'city_Name':''};
      var validataions={'city_Name':''}
      var validataions1={'city_Name':''}
      var clearData={'city_Name':''}
     ...
     this.state = {
      ...
      handleClose = () => {
        ...
        updatetDynMaster(data){
          var obj={fields:data,table_name:t_name,primarykey:"city_Id"};
