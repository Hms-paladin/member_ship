      ...
      const APIURL=apiurl;
      var t_name='mas_info_tags';    
      var objkey={'mas_info_tags_name':''};
      var objkey1={'mas_info_tags_name':''};
      var validataions={'mas_info_tags_name':''}
      var validataions1={'mas_info_tags_name':''}
      var clearData={'mas_info_tags_name':''}
      var primary_key='info_tags_id';
     ...
     this.state = {
      ...
      handleClose = () => {
        ...
        updatetDynMaster(data){
          var obj={fields:data,table_name:t_name,primarykey:"info_tags_id"};
