      ...
      const APIURL=apiurl;
      var t_name='trn_career';    
      var objkey={'career_Title':'','career_Description':'','career_Email':''};
      var objkey1={'career_Title':'','career_Description':'','career_Email':''};
      var validataions={'career_Title':'','career_Description':'','career_Email':''}
      var validataions1={'career_Title':'','career_Description':'','career_Email':''}
      var clearData={'career_Title':'','career_Description':'','career_Email':''}
      var primary_key='career_Id';
     ...
     this.state = {
      ...
      handleClose = () => {
        ...
        updatetDynMaster(data){
          var obj={fields:data,table_name:t_name,primarykey:"career_Id"};
        ...
        render() {
          ...
          return (
            ...
            <Fab color="primary" aria-label="Add" onClick={this.handleClickOpen} style={{
              ...
              <CustomizedSnackbars custommsg={this.state.message} vertical="top" horizontal="right" variant="success" openState={this.state.snackbarstate} snackbarCallback={this.closeSnackBar} />
