      ...
      const APIURL=apiurl;
      var t_name='mas_state';    
      var objkey={'state_Name':''};
      var objkey1={'state_Name':''};
      var validataions={'state_Name':''}
      var validataions1={'state_Name':''}
      var clearData={'state_Name':''}
      var primary_key='state_Id';
     ...
     this.state = {
      ...
      handleClose = () => {
        ...
        updatetDynMaster(data){
          var obj={fields:data,table_name:t_name,primarykey:"state_Id"};
