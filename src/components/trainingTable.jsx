...
const rows = [
  ...
  // },
  { id: "trn_Name", numeric: false, disablePadding: false, label: "Name" },
  { id: "trn_Description", numeric: false, disablePadding: false, label: "Description" },
  { id: "trn_FromDate", numeric: false, disablePadding: false, label: "From Date" },
  { id: "trn_ToDate", numeric: false, disablePadding: false, label: "To Date" },
  { id: "trn_StartTime", numeric: false, disablePadding: false, label: "Start Time" },
  { id: "trn_EndTime", numeric: false, disablePadding: false, label: "End Time" },
  { id: "trn_Location", numeric: false, disablePadding: false, label: "Location" },
  { id: "trn_Url", numeric: false, disablePadding: false, label: "Training Url" },
  { id: "trn_ImagePath", numeric: false, disablePadding: false, label: "Image Path" },
...
class EnhancedTrainingTable extends React.Component {
  constructor(props) {
  ...
  componentWillReceiveProps(data) {
    ...
    if (data.tblDataValues) {
      ...
      for (var i in data.tblDataValues) {
        console.log(data)
        count += 1;
        var obj = { id: count, trn_Id: data.tblDataValues[i].trn_Id, trn_Name: data.tblDataValues[i].trn_Name, trn_Description: data.tblDataValues[i].trn_Description, trn_FromDate: data.tblDataValues[i].trn_FromDate, trn_ToDate: data.tblDataValues[i].trn_ToDate, trn_StartTime: data.tblDataValues[i].trn_StartTime, trn_EndTime: data.tblDataValues[i].trn_EndTime, trn_Location: data.tblDataValues[i].trn_Location, trn_Url: data.tblDataValues[i].trn_Url, trn_ImagePath: data.tblDataValues[i].trn_ImagePath, trn_CityId: data.tblDataValues[i].trn_CityId, trn_Document: data.tblDataValues[i].trn_Document, completeDetails: data.tblDataValues[i] }
        mydata.push(obj);
                ...
                .map((n, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="left"><div className="text-truncate">{n.trn_Name}</div></TableCell>
                      <TableCell align="left"><div className="text-truncate">{n.trn_Description}</div></TableCell>
                      <TableCell align="left">{n.trn_FromDate != "null" || null ? n.trn_FromDate : ""}</TableCell>
                      <TableCell align="left">{n.trn_ToDate != "null" || null ? n.trn_ToDate : ""}</TableCell>
                      <TableCell align="left">{n.trn_StartTime != "null" || null ? n.trn_StartTime : ""}</TableCell>
                      <TableCell align="left">{n.trn_EndTime != "null" || null ? n.trn_EndTime : ""}</TableCell>
                      <TableCell align="left">{n.trn_Location != "null" || null ? n.trn_Location : ""}</TableCell>
                      <TableCell align="left">{n.trn_Url != "null" || null ? n.trn_Url : ""}</TableCell>
                      <TableCell align="left">{<img src={n.trn_ImagePath} style={{ width: "100px" }} />}</TableCell>
                      {/* <TableCell align="left">{<img src={n.trn_Document} style={{ width: "100px" }} />}</TableCell> */}
...
EnhancedTrainingTable.propTypes = {
  classes: PropTypes.object.isRequired
};

export default withStyles(styles)(EnhancedTrainingTable);
