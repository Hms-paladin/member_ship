...
const rows = [
  ...
  // },
  { id: "sur_Title", numeric: false, disablePadding: false, label: "Title" },
  { id: "sur_Description", numeric: false, disablePadding: false, label: "Description" },
  { id: "sur_Instruction", numeric: false, disablePadding: false, label: "Instruction" },
  { id: "sur_StartDateTime", numeric: false, disablePadding: false, label: "Start date" },
  { id: "sur_EndDateTIme", numeric: false, disablePadding: false, label: "End Date" }
  ];
  // var common =
  ...
  class EnhancedSurveyTable extends React.Component {
    constructor(props) {
    ...
    componentWillReceiveProps(data){
      ...
      if(data.tblDataValues){
        ...
        for(var i in data.tblDataValues){  
          // console.log(data)
          count+=1;
          var obj={id:count,sur_Id:data.tblDataValues[i].sur_Id,sur_Title:data.tblDataValues[i].sur_Title,sur_Instruction:data.tblDataValues[i].sur_Instruction,sur_Description:data.tblDataValues[i].sur_Description,sur_StartDateTime:data.tblDataValues[i].sur_StartDateTime,sur_EndDateTIme:data.tblDataValues[i].sur_EndDateTIme,completeDetails:data.tblDataValues[i]}
          mydata.push(obj);
  ...
  return (
    ...
    {stableSort(data, getSorting(order, orderBy))
      ...
      return (
        ...
        <TableCell align="left"><div className="text-truncate">{n.sur_Title}</div></TableCell>
        <TableCell align="left"><div className="text-truncate">{n.sur_Description}</div></TableCell>
        <TableCell align="left"><div className="text-truncate">{n.sur_Instruction}</div></TableCell>
        <TableCell align="left">{this.CustomDate(n.sur_StartDateTime)}</TableCell>
        <TableCell align="left">{this.CustomDate(n.sur_EndDateTIme)}</TableCell>
...
EnhancedSurveyTable.propTypes = {
  classes: PropTypes.object.isRequired
};

export default withStyles(styles)(EnhancedSurveyTable);
