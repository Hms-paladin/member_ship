...
const rows = [
  ...
  // },
  { id: "eve_Name", numeric: false, disablePadding: false, label: "Name" },
  { id: "eve_Description", numeric: false, disablePadding: false, label: "Description" },
  { id: "eve_FromDate", numeric: false, disablePadding: false, label: "From Date" },
  { id: "eve_ToDate", numeric: false, disablePadding: false, label: "To Date" },
  { id: "eve_StartTime", numeric: false, disablePadding: false, label: "Start Time" },
  { id: "eve_EndTime", numeric: false, disablePadding: false, label: "End Time" },
  { id: "eve_Location", numeric: false, disablePadding: false, label: "Location" },
  { id: "eve_Url", numeric: false, disablePadding: false, label: "Event Url" },
  { id: "eve_ImagePath", numeric: false, disablePadding: false, label: "Image Path" }
  ];
  // var common =
  ...
  class EnhancedEventTable extends React.Component {
    constructor(props) {
    ...
    componentWillReceiveProps(data){
      ...
      if(data.tblDataValues){
        ...
        for(var i in data.tblDataValues){  
          console.log(data)
          count+=1;
          var obj={id:count,eve_Id:data.tblDataValues[i].eve_Id,eve_Name:data.tblDataValues[i].eve_Name,eve_Description:data.tblDataValues[i].eve_Description,eve_FromDate:data.tblDataValues[i].eve_FromDate,eve_ToDate:data.tblDataValues[i].eve_ToDate,eve_StartTime:data.tblDataValues[i].eve_StartTime,eve_EndTime  :data.tblDataValues[i].eve_EndTime,eve_Location:data.tblDataValues[i].eve_Location,eve_Url:data.tblDataValues[i].eve_Url,eve_ImagePath:data.tblDataValues[i].eve_ImagePath,eve_CityId:data.tblDataValues[i].eve_CityId,completeDetails:data.tblDataValues[i]}
          mydata.push(obj);
  ...
  return (
    ...
    {stableSort(data, getSorting(order, orderBy))
      ...
      return (
        ...
        <TableCell align="left"><div className="text-truncate">{n.eve_Name}</div></TableCell>
        <TableCell align="left"><div className="text-truncate">{n.eve_Description}</div></TableCell>
        <TableCell align="left">{n.eve_FromDate != "null" || null  ? n.eve_FromDate : ""}</TableCell>
        <TableCell align="left">{n.eve_ToDate != "null" || null ? n.eve_ToDate : ""}</TableCell>
        <TableCell align="left">{n.eve_StartTime != "null" || null ? n.eve_StartTime : ""}</TableCell>
        <TableCell align="left">{n.eve_EndTime != "null" || null ? n.eve_EndTime : ""}</TableCell>
        <TableCell align="left">{n.eve_Location != "null" || null ? n.eve_Location : ""}</TableCell>
         <TableCell align="left">{n.eve_Url != "null" || null ? n.eve_Url : ""}</TableCell>  
        <TableCell align="left">{<img src={n.eve_ImagePath} style={{width:"100px"}}/>}</TableCell>
        </TableRow>
        );
    })}
...
EnhancedEventTable.propTypes = {
  classes: PropTypes.object.isRequired
};

export default withStyles(styles)(EnhancedEventTable);
