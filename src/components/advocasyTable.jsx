...
const rows = [
  ...
  // },
  { id: "adv_Title", numeric: false, disablePadding: false, label: "Title" },
  { id: "adv_content", numeric: false, disablePadding: false, label: "Description" },
  { id: "adv_Link", numeric: false, disablePadding: false, label: "Advocacy Url" },
  { id: "adv_Photo", numeric: false, disablePadding: false, label: "Image Path" }
];
// var common =
...
class EnhancedAdvocasyTable extends React.Component {
  constructor(props) {
  ...
  componentWillReceiveProps(data) {
    ...
    if (data.tblDataValues) {
      ...
      for (var i in data.tblDataValues) {
        ...
        count += 1;
        var obj = {
          adv_id: count, adv_Id: data.tblDataValues[i].adv_Id,
          adv_Title: data.tblDataValues[i].adv_title,
          adv_content: data.tblDataValues[i].adv_content,
          adv_Link: data.tblDataValues[i].adv_Link,
          adv_Document: data.tblDataValues[i].adv_Document,
          adv_Photo: data.tblDataValues[i].adv_Photo,
                ...
                .map((n, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="right">{n.adv_id}</TableCell>
                      <TableCell align="left"><div className="text-truncate">{n.adv_Title}</div></TableCell>
                      <TableCell align="left"><div className="text-truncate">{n.adv_content}</div></TableCell>
                      <TableCell align="left">{n.adv_Link}</TableCell>
                      <TableCell align="left">{<img src={n.adv_Photo} style={{ width: "100px" }} />}</TableCell>
                    </TableRow>
                  );
                })}
...
EnhancedAdvocasyTable.propTypes = {
  classes: PropTypes.object.isRequired
};

export default withStyles(styles)(EnhancedAdvocasyTable);
