...
const rows = [
  ...
  // },
  { id: "mas_info_cat_name", numeric: false, disablePadding: false, label: "Category Name" },
  { id: "mas_info_tags_name", numeric: false, disablePadding: false, label: "Tag Name" },
  { id: "mas_info_title", numeric: false, disablePadding: false, label: "Title" },
  { id: "mas_info_desc", numeric: false, disablePadding: false, label: "Description " },
  { id: "mas_info_link", numeric: false, disablePadding: false, label: "Link " },
  { id: "mas_info_updated_datetime", numeric: false, disablePadding: false, label: "Updated Date" },
...
class EnhancedItemTable extends React.Component {
  ...
  componentWillReceiveProps(data) {
    ...
    if (data.tblDataValues) {
      ...
      for (var i in data.tblDataValues) {
        count += 1;
        var obj = { id: count, info_id: data.tblDataValues[i].info_id, mas_info_cat_id: data.tblDataValues[i].mas_info_cat_id, mas_info_cat_name: data.tblDataValues[i].mas_info_cat_name, mas_info_tag_id: data.tblDataValues[i].mas_info_tag_id, tags: data.tblDataValues[i].tags, mas_info_title: data.tblDataValues[i].mas_info_title, mas_info_desc: data.tblDataValues[i].mas_info_desc, mas_info_link: data.tblDataValues[i].mas_info_link, mas_info_updated_datetime: data.tblDataValues[i].mas_info_updated_datetime }
        // var obj={id:count,info_id:data.tblDataValues[i].info_id,mas_info_tag_id:data.tblDataValues[i].mas_info_tag_id,mas_info_tags_name:data.tblDataValues[i].tags.mas_info_tags_name,}
        mydata.push(obj);
  ...
  render() {
    ...
    const emptyRows =rowsPerPage - Math.min(rowsPerPage, data.length - page * rowsPerPage);
      console.log(data,"mas_info_updated_datetime")
                ...
                .map((n, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="left">{n.mas_info_cat_name}</TableCell>
                      <TableCell align="left">{n.tags.map((obj) => obj.mas_info_tags_name).join(',')}</TableCell>
                      <TableCell align="left">{n.mas_info_title}</TableCell>
                      <TableCell align="left"><div className="text-truncate">{n.mas_info_desc}</div></TableCell>
                      <TableCell align="left">{n.mas_info_link}</TableCell>
                      <TableCell align="left">{n.mas_info_updated_datetime != undefined ? dateFormat(n.mas_info_updated_datetime, "yyyy-mm-dd") : ""}</TableCell>
                    </TableRow>
                  );
                })}
