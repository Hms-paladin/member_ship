...
const rows = [
  ...
  // },
  { id: "gal_Det_Title", numeric: false, disablePadding: false, label: "Title" },
  { id: "gal_Description", numeric: false, disablePadding: false, label: "Description" },
  { id: "gal_Det_MediaType", numeric: false, disablePadding: false, label: "Media Type " },
  // { id: "gal_Det_LocalMediaName", numeric: false, disablePadding: false, label: "Local Mediya Name" },
  // { id: "gal_Det_GlobalMediaURL", numeric: false, disablePadding: false, label: "Global Media Url" },
  { id: "gal_PublishDate", numeric: false, disablePadding: false, label: "Date" },
  { id: "gal_Det_Pic", numeric: false, disablePadding: false, label: "Gallery Pic" }
  ];
  // var common =
  ...
  class EnhancedGalleryTable extends React.Component {
    constructor(props) {
    ...
    componentWillReceiveProps(data){
      ...
      if(data.tblDataValues){
        ...
        for(var i in data.tblDataValues){
          count+=1;
          var obj={id:count,gal_Det_Id:data.tblDataValues[i].gal_Det_Id,gal_Description:data.tblDataValues[i].gal_Description,gal_Title:data.tblDataValues[i].gal_Title,gal_Det_Title:data.tblDataValues[i].gal_Det_Title,gal_Det_MediaType:data.tblDataValues[i].gal_Det_MediaType,gal_Det_LocalMediaName  :data.tblDataValues[i].gal_Det_LocalMediaName,gal_Det_GlobalMediaURL:data.tblDataValues[i].gal_Det_GlobalMediaURL,gal_Det_Pic:data.tblDataValues[i].gal_Det_Pic,gal_PublishDate:data.tblDataValues[i].gal_PublishDate,completeDetails:data.tblDataValues[i]}
          mydata.push(obj);
  ...
  return (
    ...
    {stableSort(data, getSorting(order, orderBy))
      ...
      return (
        ...
        <TableCell align="left"><div className="text-truncate">{n.gal_Title}</div></TableCell>
        <TableCell align="left"><div className="text-truncate">{n.gal_Description}</div></TableCell>
        <TableCell align="left">{n.gal_Det_MediaType}</TableCell>
        <TableCell align="left">{this.CustomDate(n.gal_PublishDate)}</TableCell>
        <TableCell align="left">{n.gal_Det_MediaType=="image" &&(<div><img src={n.gal_Det_GlobalMediaURL} style={{width:"100px"}}/></div>) || (<div><Player  playsInline src={n.gal_Det_GlobalMediaURL}><BigPlayButton position="center" /></Player></div>)}</TableCell>
        {/* <TableCell align="left">{n.gal_Det_Pic}</TableCell> */}
        </TableRow>
        );
    })}
...
EnhancedGalleryTable.propTypes = {
  classes: PropTypes.object.isRequired
};

export default withStyles(styles)(EnhancedGalleryTable);
